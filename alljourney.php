...
$q="select payment.*,usertable.*,vehicles.* from payment left join usertable on payment.BookingId=usertable.BookingId left join vehicles on payment.VehicleId=vehicles.Vehicle_Id order by payment.flag,payment.BookingId desc ";
...
<ul class="tab2">
  <li class="tabs"><a class="active" href="alljourney.php">ALL BOOKINGS</a></li>
  <li class="tabs"><a href="upcoming.php">UPCOMING</a></li>
  <li class="tabs"><a href="running.php">RUNNING</a></li>
  <li class="tabs"><a href="cancelled.php">CANCELLED</a></li>
...
<h5>TOTAL BOOKINGS: <?php echo $num;?> </h5>
    ...
    <div class=\"col-sm-7 \" style=\" border-left: 4px groove grey;\">
      ...
      <div class=\"align-self-end\" >
            ...
            <div class=\"recent-car-list\">
               ...
               <div >
                <span style=\"float: left; font-style:italic;\">VehicleId :$vehicleid</span>
      ...
      if($timenow>$z && $timenow<$arrivaltime && $flag==0)
       ...
       elseif ($timenow>$arrivaltime && $flag==0) {
         $status="Journey Completed";
           echo" <h5  style=\"color:orange\">Status  :  $status</h5>";
       }
