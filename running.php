...
//        and payment.BookingId=usertable.BookingId ORDER BY payment.BookingId desc ";
       $q="select payment.*,usertable.*,vehicles.* from payment left join usertable on payment.BookingId=usertable.BookingId left join vehicles on payment.VehicleId=vehicles.Vehicle_Id where flag=0 order by payment.BookingId desc";
...
<ul class="tab2">
  ...
  <li class="tabs"><a class="active"  href="running.php">RUNNING</a></li>
...
//echo $servicetime."<br>". date("Y-m-d h:i:sa", $arrivaltime)."<br>".$time."<br>";
  if($flag==0 && $timenow>$z && $timenow<$arrivaltime && $flag==0 ){
    echo "
       <div class=\"container\" style=\"margin-top: 22px\">
